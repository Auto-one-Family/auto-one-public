# Phase 2 Core Services - Vollständige Backend-Analyse
...
|-------|---------|----------|
| 58-93 | `begin()` | Initialisierung, PiEnhancedProcessor-Setup |
...
| 338-379 | `controlActuator()` | PWM-Steuerung mit Safety-Checks |
...
**Datei:** [sensor_handler.py](El%20Servador/god_kaiser_server/src/mqtt/handlers/sensor_handler.py) (698 Zeilen)
...
**Datei:** [actuator_handler.py](El%20Servador/god_kaiser_server/src/mqtt/handlers/actuator_handler.py) (458 Zeilen)
...
**Datei:** [actuator_response_handler.py](El%20Servador/god_kaiser_server/src/mqtt/handlers/actuator_response_handler.py) (280 Zeilen)
...
**Datei:** [sensor_service.py](El%20Servador/god_kaiser_server/src/services/sensor_service.py) (546 Zeilen)
...
**Datei:** [actuator_service.py](El%20Servador/god_kaiser_server/src/services/actuator_service.py) (280 Zeilen)
...
**Datei:** [safety_service.py](El%20Servador/god_kaiser_server/src/services/safety_service.py) (265 Zeilen)
...
**Datei:** [publisher.py](El%20Servador/god_kaiser_server/src/mqtt/publisher.py) (442 Zeilen)
...
| `kaiser/{kaiser_id}/esp/{esp_id}/system/error` | 1 | (Phase 0) | System-Fehler |
...
2. **Subzone-Isolation:** Phase 9 führt `isolateSubzone()` ein, aber die Server-seitige Implementierung ist nicht vollständig dokumentiert.
